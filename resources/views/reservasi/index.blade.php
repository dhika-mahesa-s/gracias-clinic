    ...
    <section class="min-h-screen bg-[#EEF2F7] text-[#526D82] py-10 px-4 animate-fadeIn">
        <div class="container mx-auto max-w-7xl">
            ...
            <div x-data="reservationForm()" x-init="init()" data-store-url="{{ route('reservasi.store') }}"
                ...
                class="max-w-5xl mx-auto mt-8 mb-24 p-8 bg-card rounded-2xl shadow-lg border border-border text-foreground relative overflow-hidden">
                ...
                <div class="min-h-[360px] relative">
                    ...
                    <div x-show="currentStep === 1" x-transition class="space-y-6">
                        ...
                        <div>
                            ...
                            <p x-show="errors.treatment_id" x-text="errors.treatment_id" class="text-red-500 text-sm mt-1">
                            </p>
                        </div>
                                ...
                                <div class="grid grid-cols-7 gap-1 text-center">
                                    ...
                                    <template x-for="d in daysInMonth" :key="d">
                                        <button type="button" @click="selectDate(d)"
                                            ...
                                            :class="{
                                                'bg-primary text-white font-semibold': form.date === formatDateLocal(
                                                    year,
                                                    month, d),
                ...
                <div x-show="showConfirmModal" x-cloak x-on:keydown.escape.window="showConfirmModal = false"
                    ...
                    <div @click.away="showConfirmModal = false"
                        class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md text-center" role="dialog"
                        aria-modal="true">
                        <h2 id="modal-title" class="text-xl font-semibold mb-3 text-gray-800">Konfirmasi Reservasi</h2>
                        <p class="text-gray-600 mb-6">Apakah Anda yakin ingin mengonfirmasi reservasi ini? Pastikan semua
                            data
                            sudah benar</p>
